...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.Note} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NoteItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Note_developer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Note_developer_feature", "_UI_Note_type"),
				 TrackerPackage.Literals.NOTE__DEVELOPER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.NOTE__COMMENT,
				 true,
				 true,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.NOTE__DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPrivatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Note_private_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Note_private_feature", "_UI_Note_type"),
				 TrackerPackage.Literals.NOTE__PRIVATE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = crop(((Note)object).getComment());

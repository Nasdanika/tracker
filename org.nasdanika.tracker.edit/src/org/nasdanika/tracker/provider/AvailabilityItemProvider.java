...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.Availability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AvailabilityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Availability_increment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Availability_increment_feature", "_UI_Availability_type"),
				 TrackerPackage.Literals.AVAILABILITY__INCREMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAvailabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Availability_availability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Availability_availability_feature", "_UI_Availability_type"),
				 TrackerPackage.Literals.AVAILABILITY__AVAILABILITY,
				 true,
				 false,
				 false,
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Availability_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Availability_comment_feature", "_UI_Availability_type"),
				 TrackerPackage.Literals.AVAILABILITY__COMMENT,
				 true,
				 true,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Availability_type") + " " + availability.getAvailability();
	}

...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAssignedToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_assignedTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_assignedTo_feature", "_UI_Category_type"),
				 TrackerPackage.Literals.CATEGORY__ASSIGNED_TO,
				 true,
				 false,
				 true,
				 null,

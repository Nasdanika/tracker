...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.Tracker} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TrackerItemProvider extends LoginPasswordRealmItemProvider {
	/**
	...
	/**
	 * This adds a property descriptor for the Auto Create Users feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAutoCreateUsersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tracker_autoCreateUsers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tracker_autoCreateUsers_feature", "_UI_Tracker_type"),
				 TrackerPackage.Literals.TRACKER__AUTO_CREATE_USERS,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tracker_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tracker_description_feature", "_UI_Tracker_type"),
				 TrackerPackage.Literals.TRACKER__DESCRIPTION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

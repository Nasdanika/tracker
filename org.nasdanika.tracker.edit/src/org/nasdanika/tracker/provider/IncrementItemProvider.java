...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.Increment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IncrementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Increment_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Increment_name_feature", "_UI_Increment_type"),
				 TrackerPackage.Literals.INCREMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Increment_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Increment_description_feature", "_UI_Increment_type"),
				 TrackerPackage.Literals.INCREMENT__DESCRIPTION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.INCREMENT__START,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.INCREMENT__END,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVersionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Increment_versions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Increment_versions_feature", "_UI_Increment_type"),
				 TrackerPackage.Literals.INCREMENT__VERSIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TrackerPackage.Literals.INCREMENT__CHILDREN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.INCREMENT__CHILDREN,

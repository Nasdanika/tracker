...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.Version} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VersionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_number_feature", "_UI_Version_type"),
				 TrackerPackage.Literals.VERSION__NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.VERSION__DESCRIPTION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.VERSION__DATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIncrementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_increment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_increment_feature", "_UI_Version_type"),
				 TrackerPackage.Literals.VERSION__INCREMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addReleasedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_released_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_released_feature", "_UI_Version_type"),
				 TrackerPackage.Literals.VERSION__RELEASED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Version)object).getNumber();

...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.REQUIREMENT__DESCRIPTION,
				 true,
				 true,
				 false,
	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_capability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_capability_feature", "_UI_Requirement_type"),
				 TrackerPackage.Literals.REQUIREMENT__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_optional_feature", "_UI_Requirement_type"),
				 TrackerPackage.Literals.REQUIREMENT__OPTIONAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = crop(((Requirement)object).getDescription());

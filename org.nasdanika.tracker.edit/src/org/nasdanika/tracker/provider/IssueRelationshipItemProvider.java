...
/**
 * This is the item provider adapter for a {@link org.nasdanika.tracker.IssueRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IssueRelationshipItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.ISSUE_RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.ISSUE_RELATIONSHIP__TYPE,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IssueRelationship_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IssueRelationship_description_feature", "_UI_IssueRelationship_type"),
				 TrackerPackage.Literals.ISSUE_RELATIONSHIP__DESCRIPTION,
				 true,
				 true,
				 false,
	...
	public String getText(Object object) {
		String label = crop(((IssueRelationship)object).getDescription());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IssueRelationship.class)) {
